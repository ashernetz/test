const types =  {
  ...
  LOADING_PRODUCTS_ERROR: '[Products] Get Products Error',
  LOADING_PRODUCTS_BY_ID_SUCCESS: '[Products] Get Product by Id success',
  LOADING_PRODUCTS__BY_ID_ERROR: '[Products] Get Products by Id Error',
